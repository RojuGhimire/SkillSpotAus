...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, description, imageUrl, label }) => {
  return (
    <div className="flex flex-col w-full p-4 lg:w-[500px]">
      <div className="relative">
        <img src={imageUrl} alt={title} className="h-64 w-full lg:w-[500px] rounded-xl lg:h-72 object-cover" />
      ...
      <div className="bg-slate-100 text-center p-4 rounded-b-lg shadow-lg mt-4">
