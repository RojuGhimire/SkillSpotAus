...
interface FirstProps {
  onNext: () => void; // Add onNext prop to handle Next button click
}
  ...
  return (
    ...
    <div className="mb-6">
        <div className="flex  items-center justify-center mb-2 ">
            ...
            <span className=" bg-gray-600 text-white w-8 h-8 flex items-center justify-center rounded-full"> 2</span>
            <div className="w-32 h-1 bg-zinc-300 mx-1"></div>
    ...
    <div className='flex flex-col items-center justify-center '>
        ...
        <button
        onClick={onNext} // Trigger next form on button click
