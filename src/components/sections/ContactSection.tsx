...
const ContactSection: React.FC = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center bg-[#F6ECED] lg:h-[657px] p-6 lg:p-10">
      ...
      {/* <div className="flex items-center ">
        <img src="/rose.png" alt="" className="text-white p-8 w-[490px] lg:w-[565.69px] lg:h-[494.27px] mt-6 lg:mt-0 lg:top-[90.65px] lg:right-[100.31px] rounded-2xl ml-0 lg:ml-10 relative" />
        <div className="absolute text-white h w-[242px] lg:mt-40">
        <h3 className="text-2xl lg:text-3xl font-bold mb-4">
          LET'S HAVE A<br /> TALK
        </h3>
        <p className="text-white font-semibold mb-1">
        ...
        <div className="flex items-center  ">
          ...
          <div className="flex items-center ">
            <BiMailSend className="text-secondary h-8 w-5   mr-5 " />
            <p className="font-semibold ">skillspotaustralia@gmail.com</p>
          </div>
        </div>
        <div className="flex space-x-8 items-center justify-center mt-6 ">
